...
class ColorCycler
{
	...
	private static inline var WilliamsFlashFrameDelay:Float = 0.05; // was 0.04
	...
	{
		RGBTimer += FlxG.elapsed;
		RWBTimer += FlxG.elapsed;
		WilliamsFlashTimer += FlxG.elapsed;
		WilliamsUltraFlashTimer += FlxG.elapsed;
		SternFlashTimer += FlxG.elapsed;
		RedPulseTimer += FlxG.elapsed;
		BluePulseTimer += FlxG.elapsed;
		RedYellowFlashTimer += FlxG.elapsed;
		ExplosionFlashTimer += FlxG.elapsed;
		BlasterTextTimer += FlxG.elapsed;
		RainbowFlashTimer += FlxG.elapsed;
